...
if __name__ == "__main__":
    ...
    agent.load_model("../output_dir_susceptibility/1000.pt")
    agent.eval_check(eval=True)
    anneal_steps = 50000
    epsilon = 0
    min_epsilon = 0
    ...
    for e in range(num_iteration):
        ...
        episode_reward, epsilon, t, eval = train(agent, env, e, t, 100, epsilon=epsilon, min_epsilon=min_epsilon, anneal_epsilon=anneal_epsilon , initializer=False, output_dir=None, vdn=True)
