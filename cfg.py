...
def get_cfg():
    ...
    parser.add_argument("--sigma_init", type=float, default=0.5, help="sigma_init")
    ...
    parser.add_argument("--n_representation_action", type=int, default=12, help="")
    parser.add_argument("--iqn_layer_size", type=int, default=64, help="")
    parser.add_argument("--iqn_N", type=int, default=24, help="")
