...
def get_cfg():
    ...
    parser.add_argument("--temperature", type=int, default=2, help="")
    parser.add_argument("--interval_min_blue", type=bool, default=True, help="interval_min_blue")
    parser.add_argument("--interval_constant_blue", type=float, default=0.00001, help="interval_constant_blue")
