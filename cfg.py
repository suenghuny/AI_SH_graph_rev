...
def get_cfg():
    ...
    parser.add_argument("--GNN", type=str, default='HGNN', help="map name")
    ...
    parser.add_argument("--hidden_size_meta_path", type=int, default=14, help="GNN hidden layer")
    parser.add_argument("--hidden_size_meta_path2", type=int, default=14, help="GNN hidden layer")
    ...
    parser.add_argument("--n_representation_action", type=int, default=15, help="")
    parser.add_argument("--n_representation_action2", type=int, default=16, help="")
    ...
    parser.add_argument("--grad_clip_reduce", type=float, default=0.5, help="reduced_gradient clipping")
    ...
    parser.add_argument("--n_eval", type=int, default=100, help="number of evaluation")
