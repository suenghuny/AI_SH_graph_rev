...
def get_cfg():
    ...
    parser.add_argument("--n_cos", type=int, default=48, help="")
    ...
    parser.add_argument("--gamma", type=float, default=.94, help="discount ratio")
    ...
    parser.add_argument("--scheduler_step", type =int, default=24000, help= "scheduler step")
    ...
    parser.add_argument("--anneal_step", type=int, default=80000, help="epsilon")
