...
def get_cfg():
    ...
    parser.add_argument("--n_step", type=int, default=3, help="n_step")
    ...
    parser.add_argument("--iqn_layers", type=str, default= '[128, 84, 64, 48, 36]', help="layer 구조")
    ...
    parser.add_argument("--buffer_size", type=int, default=70000, help="")
